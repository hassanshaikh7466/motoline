        ...
        return(
          ...
          <div className="UniversalDetailedItem">
            ...
            <Typography gutterBottom variant="h5" component="h2" className={classes.typography}>
              <Grid container>
                <Grid item xs={6}>
                  <div className="UniversalPartImage">
                  <img src={this.state.partDetails.imageURL} height="500px" width="500px" alt={this.state.partDetails.name}/>
                  </div>
                  </Grid>
                <Grid item xs={6}>
              <div className="UniversalPartDetails">
                Name: {this.state.partDetails.name}<br/>
                Description: {this.state.partDetails.description}<br/>
                Company: {this.state.partDetails.company}<br/>
                MRP: {this.state.partDetails.mrp}<br/>
                Delivery in {this.state.partDetails.delivery}
                </div>
                </Grid>
                </Grid>
            </Typography>
