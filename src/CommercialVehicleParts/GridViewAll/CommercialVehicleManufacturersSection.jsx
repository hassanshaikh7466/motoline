...
class CommercialVehicleManufacturerSection extends Component{
    constructor(props){
        super(props);
        this.state = {manufacturers:[],isLoaded:false}
    }
    componentWillMount(){
        const dbref = firebase.database().ref().child('CommercialVehicles')
        const manufacturers = []
    ...
    render(){
        ...
        return(
            <div className={this.state.manufacturers.length>4 ? "CommercialVehicleManufacturersSection" :"CommercialVehicleManufacturersSectionLess"}>
...
CommercialVehicleManufacturerSection.propTypes = {
    classes: propTypes.object.isRequired,
};
  
export default withStyles(styles)(CommercialVehicleManufacturerSection)