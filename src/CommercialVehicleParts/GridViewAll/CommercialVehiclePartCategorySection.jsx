...
function CommercialVehiclePartCategorySection(props){
    ...
    function engineOptionBack(){ props.handleEngineOptionBack()}
        const { classes } = props; 
        return(
            <div className="CommercialVehiclePartCategorySection">
            ...
            <Button variant="flat" className={classes.button} onClick={engineOptionBack}>Part Categories</Button><br/>
            </div>
            </Grid>
            <Grid item xs={12}>
            <PartCategoryGrid 
            ...
            <Button variant="flat" className={classes.buttonPortrait} onClick={engineOptionBack}>Part Categories</Button><br/>
            </div>
            </Grid>
            <Grid item xs={12}>
            <PartCategoryGrid 
...
CommercialVehiclePartCategorySection.propTypes = {
...
export default withStyles(styles)(CommercialVehiclePartCategorySection)