...
class CarModelSection extends Component{
    constructor(props){
        super(props);
    ...
    render(){
      ...
      return(
        <div className={this.state.models.length<=4 ? "CarModelsSectionLess" :"CarModelsSection"}>
        ...
        Search:<br/><TextField className={classes.textField} {...getInputProps()} margin="normal"/>
        </div>
        <Grid container>
        {isOpen
        ? this.state.models
        ...
        Navigate to<Button variant="flat" className={classes.buttonPortrait} onClick={this.manufacturerBack}>Manufacturers</Button><br/>
        </div>
        <Downshift onChange={selection => { this.props.handleData(selection.name)}} itemToString={item => (item ? item.name : '')}>
        {({getInputProps,isOpen,inputValue}) => (
        <div>
        <div className="TextfieldPortrait">
        Search:<br/><TextField className={classes.textFieldPortrait} {...getInputProps()} margin="normal"/>
        </div>
        <Grid container>
        {isOpen
        ? this.state.models
...
export default withStyles(styles)(CarModelSection)