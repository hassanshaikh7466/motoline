...
class PartCategoryGrid extends Component{
    ...
    componentWillMount(){
        const dbref = firebase.database().ref().child('CarParts/'+this.props.partCategory);
        const parts = [];
        const filteredParts = []
    ...
    render(){
        ...
        <div className="CarPartCategories">
        ...
        <PartsView manufacturer={this.props.manufacturer} 
        model={this.props.model} engineOption={this.props.engineOption} 
        partCategory={this.props.partCategory} partDetails={item}/>
        </Slide>
        </Grid>))
        : <Grid container>
        ...
        <Slide direction="right" in={true} mountOnEnter unmountOnExit timeout={500}>
        <PartsView manufacturer={this.props.manufacturer} model={this.props.model} 
        engineOption={this.props.engineOption} partCategory={this.props.partCategory}
        partDetails={p}/>
        </Slide>
        </Grid>)}
        </Grid>}
        ...
        <div className="CarPartCategoriesPortrait">
        {this.state.parts.length!==0
        ? <div className={classes.root}>
