...
class PartsView extends Component{
            ...
            if(snap.val().email===firebase.auth().currentUser.email){
              ...
              const cartRef = firebase.database().ref().child('Users/'+snap.key+'/Cart');
                cartRef.push().set({
                    ...
                    compatibleWith:{manufacturer:this.props.manufacturer,model:this.props.model,engineOption:this.props.engineOption,type:"Specific"},
                    mrp:partDetails.mrp,
                    qty:1,
    ...
    render(){
        ...
        <Grid container>
        <Grid item xs={6}>
        <div className="CarPartImage"><img src={this.props.partDetails.imageURL} height="500px" width="500px" alt={this.props.partDetails.name}/></div>
        </Grid>
        <Grid item xs={6}>
        <div className="CarPartDetails">
        ...
        <div className="CarPartsViewPortrait">
        ...
        <Grid container>
        <Grid item xs={12}>
        <div className="CarPartImage"><img src={this.props.partDetails.imageURL} height="250px" width="250px" alt={this.props.partDetails.name}/></div>
        </Grid>
        <Grid item xs={12}>
        <div className="CarPartDetails">
        Name: {this.props.partDetails.name}<br/>
